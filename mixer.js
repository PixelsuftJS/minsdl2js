...
e.SDL_MIXER_PATCHLEVEL = e.MIX_PATCHLEVEL = 2;
...
exports.library_exports = {
  ...
  'Mix_SetPostMix': ['void', [Func('void', ['void*', 'Uint8*', 'int']), 'void*']],
  'Mix_HookMusic': ['void', [Func('void', ['void*', 'Uint8*', 'int']), 'void*']],
  'Mix_HookMusicFinished': ['void', [Func('void', [])]],
  'Mix_GetMusicHookData': ['void*', []],
  'Mix_ChannelFinished': ['void', [Func('void', ['int'])]],
  ...
  'Mix_EachSoundFont': ['int', [Func('int', ['string', 'void*']), 'void*']],
