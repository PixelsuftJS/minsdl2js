...
if (e.SDL_IMAGE_MAJOR_VERSION < 3 && e.SDL_MAJOR_VERSION) {
  e.SDL_IMAGE_COMPILEDVERSION = function() {
    return e.SDL_VERSIONNUM(e.SDL_IMAGE_MAJOR_VERSION, e.SDL_IMAGE_MINOR_VERSION, e.SDL_IMAGE_PATCHLEVEL);
  }
}
...
exports.library_exports = {
  ...
  'IMG_ReadXPMFromArray': [ref.refType(e.SDL_Surface), ['char**']],
  'IMG_ReadXPMFromArrayToRGB888': [ref.refType(e.SDL_Surface), ['char**']],
