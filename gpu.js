...
exports.library_exports = {
  ...
  'GPU_SetShaderImage': ['void', ['void*', 'int', 'int']],
  'GPU_GetUniformiv': ['void', ['Uint32', 'int', 'int*']],
  'GPU_SetUniformi': ['void', ['int', 'int']],
  'GPU_SetUniformiv': ['void', ['int', 'int', 'int', 'int*']],
  'GPU_GetUniformuiv': ['void', ['Uint32', 'int', 'Uint*']],
  'GPU_SetUniformui': ['void', ['int', 'Uint']],
  'GPU_SetUniformuiv': ['void', ['int', 'int', 'int', 'Uint*']],
  'GPU_GetUniformfv': ['void', ['Uint32', 'int', 'float*']],
  'GPU_SetUniformf': ['void', ['int', 'float']],
  'GPU_SetUniformfv': ['void', ['int', 'int', 'int', 'float*']],
  'GPU_GetUniformMatrixfv': ['void', ['Uint32', 'int', 'float*']],
  'GPU_SetUniformMatrixfv': ['void', ['int', 'int', 'int', 'int', e.GPU_bool, 'float*']],
  'GPU_SetAttributef': ['void', ['int', 'float']],
  'GPU_SetAttributei': ['void', ['int', 'int']],
  'GPU_SetAttributeui': ['void', ['int', 'Uint']],
  'GPU_SetAttributefv': ['void', ['int', 'int', 'float*']],
  'GPU_SetAttributeiv': ['void', ['int', 'int', 'int*']],
  'GPU_SetAttributeuiv': ['void', ['int', 'int', 'Uint*']],
  'GPU_SetAttributeSource': ['void', ['int', e.GPU_Attribute]]
};
