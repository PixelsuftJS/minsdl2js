...
e.SDL_TTF_PATCHLEVEL = e.TTF_PATCHLEVEL = 1;
...
if (e.SDL_TTF_MAJOR_VERSION < 3 && e.SDL_MAJOR_VERSION) {
  e.SDL_TTF_COMPILEDVERSION = e.SDL_VERSIONNUM(e.SDL_TTF_MAJOR_VERSION, e.SDL_TTF_MINOR_VERSION, e.SDL_TTF_PATCHLEVEL);
}
